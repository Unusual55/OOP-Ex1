...
class Building:
    __building_fields = ['_minFloor', '_maxFloor', '_elevators']
    ...
    def parse_from_json(json_path: str):
        with open(json_path, mode='r') as f:
            ...
            return Building.parse_building(buildingDict)

    def parse_building(self, building: dict):
        Building.validate_building(building)
        return Building(building['_minFloor'], building['_maxFloor'],  *[Elevator.parse_elevator(elevator) for elevator in building['_elevators']])

    @staticmethod
    def validate_building(building: dict):
        properties = Building.__building_fields
